    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <nav className="container-max py-4 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          {/* Right Side - Termin buchen Button & Icons */}
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <a 
              ...
              className="bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 rounded-full font-semibold text-sm transition-colors duration-300 shadow-lg"
            >
              Termin buchen
            </a>
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4 py-4 border-t border-gray-200">
            <div className="flex flex-col space-y-4">
              ...
              {/* Mobile Termin buchen Button */}
              <div className="pt-4">
                <a 
                  href="https://planity.com" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 rounded-full font-semibold text-sm transition-colors duration-300 shadow-lg inline-block"
                >
                  Termin buchen
                </a>
              </div>
